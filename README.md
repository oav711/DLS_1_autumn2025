...
├── notebooks/
│   ├── 1_Analyze_FaceAlignment_oav.ipynb/                # Решение задания №1 - анализ датасета, стратифицированная выборка, реализация и обучение Stacked Hourglass Network, выравнивание лиц 
│   ├── 2_ArcFace_oav.ipynb/                              # Решение задания №2 - реализация и обучение нейросетей для 3 части пайплайна (распознавание лиц) на CE loss и ArcFace Loss
│   ├── 2_1_dop_Identification_Rate_Metric_oav.ipynb/     # Решение дополнительного задания №1 - реализация актуальной для задачи Face Recognition метрику Identification Rate Metric
│   └── 2_2_dop_Triplet_Loss_oav.ipynb                    # Решение дополнительного задания №2 - реализация Triplet loss
├── pipeline_oav.py                                       # Решение задания №3 - основной модуль пайплайна
├── call_pipeline_oav.ipynb                               # Демонстрация запуска пайплайна в разных режимах работы
├── checkpoints/                                          # Веса моделей (ссылка на облако в README.md)
├── data_CelebA_mini
│       ├── data\                                         # отобранные 11000 изображений из полного датасета CelebA
│       │     └── *.jpg
...
├── image1(2,3).jpg                                       # Образцы групповых изображений для демонстрации работы пайплайна
